...
% Last Modified by GUIDE v2.5 29-May-2016 19:08:27
...
Imput_Signal=get(handles.popupmenu1,'Value');%Номер входного сигнала
...
switch Number_Metod
    ...
    [e,W,Y]=LMS_metod(d,Uinter,mu,step);%LMS метод
     ...
     e2=d2-Y2; 
    case 3
     [e,W,Y]=RLS_metod(d,Uinter);%RLS метод
     Y2=W'*U_tap;
     e2=d2-Y2; 
    case 4
